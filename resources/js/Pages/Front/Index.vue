...
<template>
  ...
  <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-32 p-4">
     <h1 class="text-lg font-bold">Bayu Erlangga </h1>
      <button
          ...
          <li>
            <div v-if="canLogin">
              <Link
                ...
                class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0">
                Dashboard
              </Link>
              <template v-else>
                <Link :href="route('login')" type="button" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0"> Log in</Link>
              </template>
            </div>
          </li>
        </ul>
      ...
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          ...
          <div class="grid grid-cols-1 gap-2 md:flex md:justify-start">
            <button type="button" class="bg-purple-400 hover:bg-purple-500 text-black rounded-lg px-4 py-2 mt-7">Primary</button>
      ...
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        <div className="sm:col-span-12 lg:col-span-3">
          ...
          <div className="text-sm text-gray-600">
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-black uppercase">Bayu Erlangga <br/>Saputra</span>
          </div>
        </div>
